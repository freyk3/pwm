                ...
                <div class="panel-body">
                    <form class="form-horizontal" role="form" method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group{{ $errors->has('music') ? ' has-error' : '' }}">
                            <label for="music" class="col-md-4 control-label">Перечислите предпочитаемую музыку</label>

                            <div class="col-md-6">
                                <input id="music" type="text" class="form-control" name="music" value="{{ old('music') }}">
                        ...
                        И тут ещё надо добавить шляпу с добавлением аватарки
